class timeReport:
    def __init__(self, lineNum, simulation):
        ...
        nameinput = input("Ingrese el nombre del producto para generar el reporte: ")
        simName = str(simulation.name)
        simProd = simulation.products.first
        ...
        if nameinput.lower() == tempName.lower():
            numBreak = input("Ingrese el segundo hasta el que se quiere simular: ")
            Generar = True
            if int(numBreak) > int(timeProd) or int(numBreak) <= 0:
                Generar = False
            Encontrado = True
            if Generar == True:
                html = open("reportes/simulaciones/html/reporteProducto_" + nameinput + ".html", "w")
                ...
                <body>
                    ...
                    <div class="container">
                        ...
                        <div class="col-md-8 offset-md-2">
                            ...
                            <h1 style="color: white; font-size:120px; text-align: center; font-style: italic; font-family:'Gill Sans', 'Gill Sans MT', Calibri, 'Trebuchet MS', sans-serif; text-transform:uppercase">""" + nameinput + """</h1>
                            </div>
                        </div>
                        </div>
                    </div>
                ...
                print("\n")
                print("El proceso de este producto no llega hasta ese segundo específico")
                print("\n")
